...
// -------------------------------------------------------------------------
inline _LettersBasePFM::_LettersBasePFM() {
    initSettings();
}

inline std::vector<PFMSetting> _LettersBasePFM::defineSettings() const {
    return {
...
inline std::vector<DrawingGeometry> _LettersBasePFM::_process(const cv::Mat& image) {
    int w = image.cols;
    int h = image.rows;
...
inline BaseAdaptivePFM::BaseAdaptivePFM() {
    initSettings();
}

inline std::vector<PFMSetting> BaseAdaptivePFM::defineSettings() const {
    return {
...
inline std::vector<cv::Point2f> BaseAdaptivePFM::getSeeds(const cv::Mat& image) {
    int w = image.cols;
    int h = image.rows;
...
// --- base_grid_pfm.cpp ---
inline BaseGridPFM::BaseGridPFM() {
    initSettings();
}

inline std::vector<PFMSetting> BaseGridPFM::defineSettings() const {
    return {
...
inline BaseMazePFM::BaseMazePFM() {
    initSettings();
}

inline std::vector<PFMSetting> BaseMazePFM::defineSettings() const {
    return {
        {"complexity", "Complexity", SettingType::Integer, 10, SettingValue(), 1, 50, 1, 50, 1}
    };
}

inline std::pair<float, float> BaseMazePFM::transformPoint(float x, float y) { return {x, y}; }

inline std::vector<DrawingGeometry> BaseMazePFM::_process(const cv::Mat& image) {
...
// --- base_mosaic_pfm.cpp ---
inline BaseMosaicPFM::BaseMosaicPFM() {
    initSettings();
}

inline std::vector<PFMSetting> BaseMosaicPFM::defineSettings() const {
    return {
...
inline BaseMultiHatchPFM::BaseMultiHatchPFM() {
    initSettings();
}

inline std::vector<PFMSetting> BaseMultiHatchPFM::defineSettings() const {
    return {
...
inline std::vector<DrawingGeometry> BaseMultiHatchPFM::_process(const cv::Mat& image) {
...
inline BaseStipplePFM::BaseStipplePFM() {
    initSettings();
}

inline std::vector<PFMSetting> BaseStipplePFM::defineSettings() const {
    return {
...
inline std::vector<DrawingGeometry> BaseStipplePFM::_process(const cv::Mat& image) {
    int w = image.cols;
    int h = image.rows;
...
inline BaseStreamlinePFM::BaseStreamlinePFM() {
    initSettings();
}

inline std::vector<PFMSetting> BaseStreamlinePFM::defineSettings() const {
    return {
...
inline BaseVoronoiExtraPFM::BaseVoronoiExtraPFM() {
    initSettings();
}

inline std::vector<PFMSetting> BaseVoronoiExtraPFM::defineSettings() const {
    return {
        {"cell_count", "Cell Count", SettingType::Integer, 800, SettingValue(), 50, 20000, 50, 20000, 100},
...
inline std::vector<cv::Point2f> BaseVoronoiExtraPFM::getSeeds(const cv::Mat& image) {
    int w = image.cols;
    int h = image.rows;
    int cell_count = m_settings["cell_count"].toInt();
