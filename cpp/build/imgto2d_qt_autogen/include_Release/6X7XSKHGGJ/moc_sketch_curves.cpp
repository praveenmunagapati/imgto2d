...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSSketchCubicBeziersPFMENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSketchCubicBeziersPFMENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSketchCubicBeziersPFMENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SketchCubicBeziersPFM::staticMetaObject = { {
    QMetaObject::SuperData::link<PathFindingModule::staticMetaObject>(),
    qt_meta_stringdata_CLASSSketchCubicBeziersPFMENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSketchCubicBeziersPFMENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSketchCubicBeziersPFMENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSketchCubicBeziersPFMENDCLASS.stringdata0))
        return static_cast<void*>(this);
    return PathFindingModule::qt_metacast(_clname);
}
